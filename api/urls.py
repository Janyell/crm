...
urlpatterns = patterns('',
                       ...
                       url(r'^massive/delete/reasons/$',
                           'base_api.views.massive_delete_reasons',
                       ...
                       url(r'^massive/activate_reasons/$',
                           'base_api.views.massive_activate_reasons',
                           name='massive_activate_reasons'),
                       url(r'^massive/deactivate_reasons/$',
                           'base_api.views.massive_deactivate_reasons',
                       ...
                       url(r'^settings/reasons/$', 'base_api.views.get_reasons',
                           name='get_reasons'),
                       url(r'^settings/reasons/edit/$', 'base_api.views.edit_reason',
                           name='edit_reason'),
                       url(r'^settings/reasons/delete/$', 'base_api.views.delete_reason',
                           name='delete_reason'),
                       ...
                       url(r'^tasks/do/$', 'base_api.views.do_task', name='do_task'),

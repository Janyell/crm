...
urlpatterns = patterns('',
                       ...
                       url(r'^analyst/product-groups/$', 'base_api.full_views.analyze_products.full_analyze_products_groups',
                           name='analyze_products_groups'),
                       url(r'^analyst/product-groups/view/$', 'base_api.full_views.analyze_products.full_view_analyzed_product_groups',
                           name='view_analyzed_product_groups'),
                       url(r'^analyst/product-groups/$', 'base_api.views.analyze_product_groups',
                           name='analyze_product_groups'),
                       url(r'^analyst/products-groups/view/$', 'base_api.views.view_analyzed_product_group',
                       ...
                       url(r'^sources/delete/$', 'base_api.full_views.source_views.full_delete_source',
                           name='delete_source'),

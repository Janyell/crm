...
urlpatterns = patterns('',
                       ...
                       url(r'^companies/add/$', 'base_api.views.add_edit_company', {'action': 'add', 'id': '12'},
                           name='add_company'),
                       url(r'^companies/edit/(?P<id>\d+)/$', 'base_api.views.add_edit_company', {'action': 'edit'},
                           name='edit_company'),
                       url(r'^companies/delete/(?P<id>\d+)/$', 'base_api.views.delete_company', name='delete_company'),

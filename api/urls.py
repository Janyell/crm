...
urlpatterns = patterns('',
                       ...
                       url(r'^analyst/period/$', 'base_api.views.analyze_period',
                           name='analyze_period'),
                       url(r'^analyst/city_period/$', 'base_api.full_views.analyze_city.full_analyze_city',
                           name='analyze_city_period'),
                       url(r'^analyst/period_groups/$', 'base_api.views.analyze_period_product_groups',
                       ...
                       url(r'^product_groups/$', 'base_api.views.get_product_groups', name='get_product_group'),
                       url(r'^product_groups/edit/$', 'base_api.views.edit_product_group', name='edit_product_group'),
                       url(r'^product_groups/delete/$', 'base_api.views.delete_product_group', name='delete_product_group'),
                       ...
                       url(r'^massive/change_manager/$', 'base_api.full_views.massive_edit.massive_change_manager_in_order',
                       ...
                       url(r'^massive/deactivate_products/$', 'base_api.full_views.massive_edit.massive_deactivate_product',
                       ...
                       url(r'^massive/change_product_group/$', 'base_api.full_views.massive_edit.massive_change_product_group',
                           name='massive_change_product_group'),
                       url(r'^sources/$', 'base_api.full_views.source_views.full_get_sources', name='get_sources'),
                       url(r'^sources/edit/$', 'base_api.full_views.source_views.full_edit_source', name='edit_source'),
                       url(r'^sources/delete/$', 'base_api.full_views.source_views.full_delete_source', name='delete_source'),
                       ...
                       url(r'^generate_kp/$',  'base_api.full_views.kp_model.full_generate_kp', name='generate_kp'),

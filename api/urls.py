...
urlpatterns = patterns('',
                       ...
                       url(r'^massive/delete/transport_companies/$',
                           'base_api.views.massive_delete_transport_companies',
                       ...
                       url(r'^massive/activate_transport_companies/$',
                           'base_api.views.massive_activate_transport_companies',
                           name='massive_activate_transport_companies'),
                       url(r'^massive/deactivate_transport_companies/$',
                           'base_api.views.massive_deactivate_transport_companies',
                       ...
                       url(r'^settings/sources/delete/$', 'base_api.full_views.source_views.full_delete_source',
                           name='delete_source'),
                       url(r'^settings/transport_companies/$', 'base_api.views.get_transport_companies',
                           name='get_transport_companies'),
                       url(r'^settings/transport_companies/edit/$', 'base_api.views.edit_transport_company',
                           name='edit_transport_company'),
                       url(r'^settings/transport_companies/delete/$', 'base_api.views.delete_transport_company',
